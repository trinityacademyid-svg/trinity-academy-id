        ...
        <div className="footer-grid" style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 24 }}>
              <p style={{ fontSize: '0.875rem' }}>📱 +62 812-3456-7890</p>
              <p style={{ fontSize: '0.875rem' }}>📧 info@trinityacademy.id</p>
              <p style={{ fontSize: '0.875rem' }}>🕐 Senin–Minggu, 08.00–21.00 WIB</p>
            </div>
            <a href="https://wa.me/6281234567890" target="_blank" rel="noreferrer"
              style={{
